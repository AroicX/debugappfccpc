...
const DropdownBox = () => {
  ...
  const onDelete = () => {
    swal({
      title: ' Checklist Successfully Deleted!',
                ...
                <table className="hover">
                  <thead>
                    <tr className="table-header">
                      <th> TITLE</th>
                      <th>SECTION</th>
                      <th className="sort-numeric">SUB & SECTION</th>
                      <th>VISIBILITY</th>
                      <th>ACTIONS</th>
                    </tr>
                  </thead>
                  <tbody className=" table ">
                    <tr>
                      ...
                      <td>{'{S, 94}'} </td>
                      <td>Competiton Analysis, {'{S, 94}'}</td>
                      <td>
                        <div className=" table-btn approved">YES</div>{' '}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>Competiton Analysis, {'{S, 94}'}</td>
                      <td>
                        <div className=" table-btn rejected">NO</div>{' '}
                      </td>
